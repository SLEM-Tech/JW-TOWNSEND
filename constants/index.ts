...
export const headerNavLinks: linksProps[] = [
	{ id: 1, href: "/", text: "Home" },
	{ id: 1, href: "/category", text: "Shop" },
	{ id: 5, href: "/contact-us", text: "Contact Us" },
];

export const heroImages = [
	{ id: 1, src: furnitureImg, alt: "GRAPHIC S) S.SALVA", category: "GRAPHIC" },
	{ id: 2, src: goldenImg, alt: "STUDIO AZ) me", category: "STUDIO" },
	{
		id: 3,
		src: graphicsImg,
		alt: "FURNITURE Cr) ERANEL",
		category: "FURNITURE",
	},
	{ id: 4, src: salvaImg, alt: "design LOOKBOOK", category: "design" },
	{ id: 5, src: travelImg, alt: "design LOOKBOOK", category: "travel" },
];
