				...
				<div className='grid slg:grid-cols-2 mt-2 sm:mt-5 slg:mt-10 px-4 slg:px-16 overflow-hidden'>
					<div className='flex flex-col gap-2'>
						<h3 className='slg:text-2xl text-lg font-semibold text-center slg:text-start'>
							Welcome to our International Trans Co Supply Limited
						</h3>

						<div className='flex flex-col gap-4'>
							<h3 className='text-xl md:text-2xl lg:text-3xl font-bold text-center md:text-left text-primary'>
								Welcome to International Trans Co Supply Limited
							</h3>

							<div className='text-base md:text-lg leading-relaxed text-gray-700 max-w-4xl space-y-4'>
								<p>
									International Trans Co Supply Limited is a premier global
									logistics &amp; supply chain solutions provider,&nbsp;
									specializing in seamless cross&#8209;border transportation
									&amp; customized procurement services. With our extensive
									network &amp; industry expertise, we deliver:
								</p>
