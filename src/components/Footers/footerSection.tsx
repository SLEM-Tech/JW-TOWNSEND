...
const Footer = () => {
	...
	return (
		<footer className='relative overflow-hidden bg-primary text-white w-full py-2 px-4 sm:px-8 lg:px-12 flex flex-col item-center'>
			<div className='mx-auto overflow-hidden w-full hidden slg:block'>
				<section className='flex justify-center gap-4 mt-2 '>
					<div className='flex flex-col gap-4 w-[80%]'>
						<LogoImage className='rounded-sm' />
						<span className='-mt-8 text-white text-base leading-[1.6] font-[400]'>
				...
				<section className='flex flex-col justify-between gap-1 sm:gap-6 mt-2 px-2 xs:px-6 sm:px-10'>
					<div className='flex w-full justify-between items-end gap-4'>
						<div className=''>
							...
							<span className='text-white text-xs sm:text-base leading-[1.6] font-[400]'>
								..The best store for you!
							</span>
						</div>
			...
			<div className='mx-auto max-w-[1156px]'>
				<div className='flex items-center justify-center py-2'>
					<div className='text-white text-[8px] sm:text-[10px] slg:text-xs font-[400] leading-[1.2]'>
